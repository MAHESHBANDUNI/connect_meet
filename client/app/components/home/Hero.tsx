        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
                ...
                {showMeetingOptions && (
                  <div className="absolute right-0 top-full mt-2 w-full bg-white border rounded-lg z-50 shadow-md border-gray-200">
                    <button
                      ...
                      className="w-full text-left font-medium px-4 py-2 text-sm sm:text-lg text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded-lg transition align-items-center flex"
                    >
              ...
              <div className="flex items-center px-4 py-4 border-2 border-gray-300 text-gray-900 rounded-lg hover:border-blue-600 hover:bg-gray-50 transition-all text-lg bg-white shadow-lg">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-linear-to-r from-blue-400 to-indigo-500 rounded-full opacity-20 animate-float" style={{ animationDelay: '2s' }}></div>
          </div>
        </div>
      </div>
