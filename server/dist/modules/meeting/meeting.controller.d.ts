...
export declare class MeetingController {
    ...
    admitParticipant: (req: Request, res: Response, next: import("express").NextFunction) => void;
    rejectParticipant: (req: Request, res: Response, next: import("express").NextFunction) => void;
